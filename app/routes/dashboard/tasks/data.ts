...
export const tasks: Task[] = [
  {
    ...
    board: { id: 'b1', name: 'Marketing', slug: 'marketing', prefix: 'MKT', color: 'blue', createdAt: '2025-01-01', updatedAt: '2025-01-01' },
    dueDate: '2025-08-05',
  ...
  },
  {
    ...
    board: { id: 'b2', name: 'Editorial', slug: 'editorial', prefix: 'EDI', color: 'green', createdAt: '2025-01-01', updatedAt: '2025-01-01' },
    dueDate: '2025-08-01',
  ...
  },
  {
    ...
    board: { id: 'b3', name: 'Ecommerce Dev', slug: 'ecommerce-dev', prefix: 'ECOM', color: 'purple', createdAt: '2025-01-01', updatedAt: '2025-01-01' },
    dueDate: '2025-07-30',
  ...
  },
  {
    ...
    author: { id: 'u1', name: 'Mariana Torres', nickname: 'Mariana', email: 'mariana@example.com', roles: [Roles.ADMIN], avatar: 'https://via.placeholder.com/150', isActive: true },
    assignedTo: { id: 'u2', name: 'Carlos Ruiz', nickname: 'Carlos', email: 'carlos@example.com', roles: [Roles.DESIGNER], avatar: 'https://via.placeholder.com/150', isActive: true },
    board: { id: 'b4', name: 'Clientes Potenciales', slug: 'clientes-potenciales', prefix: 'CLP', color: 'red', createdAt: '2025-01-01', updatedAt: '2025-01-01' },
    dueDate: '2025-08-10',
